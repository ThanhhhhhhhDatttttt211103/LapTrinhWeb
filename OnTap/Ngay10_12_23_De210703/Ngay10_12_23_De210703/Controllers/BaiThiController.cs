...
namespace Ngay10_12_23_De210703.Controllers
{
	public class BaiThiController : Controller
	{
		...
		{
			var hangHoas = db.Products.Where(m => m.UnitPrice <= 1000 && m.Available == true).ToList();
			return View(hangHoas);
		}

		public IActionResult HangHoaByFilter(int mid)
		{
			var hangHoas = db.Products.Where(m => m.UnitPrice <= 1000 && m.CategoryId == mid).ToList();
